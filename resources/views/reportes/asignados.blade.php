<x-app-layout>
    ...
    <body>
        <div class="report-container">
                ...
                <div class="company-logo">
                    ...
                    <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                        ...
                        <path
                            ...
                            fill="white" />
                        <path
                            d="M30 33.3333C31.8409 33.3333 33.3333 31.8409 33.3333 30C33.3333 28.159 31.8409 26.6666 30 26.6666C28.159 26.6666 26.6666 28.159 26.6666 30C26.6666 31.8409 28.159 33.3333 30 33.3333Z"
                            fill="#3b82f6" />
                    </svg>
                </div>
            ...
            <!-- Filtros de búsqueda -->
            <form method="GET" action="{{ route('reportes.asignados') }}" class="no-print mb-6">
                <div class="flex flex-col sm:flex-row flex-wrap gap-4 items-end">
                    <!-- Filtro por tipo -->
                    <div>
                        <label for="tipo" class="block text-sm text-gray-600">Tipo</label>
                        <select name="tipo" id="tipo" class="border-gray-300 rounded-md shadow-sm">
                            <option value="">Todos</option>
                            <option value="mobiliario" {{ request('tipo') == 'mobiliario' ? 'selected' : '' }}>
                                Mobiliario</option>
                            <option value="dispositivo" {{ request('tipo') == 'dispositivo' ? 'selected' : '' }}>
                                Dispositivo</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label for="empleado" class="block text-sm text-gray-600">Empleado</label>
                        <input type="text" name="empleado" id="empleado" value="{{ request('empleado') }}"
                            class="border-gray-300 rounded-md shadow-sm px-2 py-1" placeholder="Nombre del empleado">
                    </div>

                    <!-- Filtro por nombre del elemento -->
                    <div>
                        <label for="elemento" class="block text-sm text-gray-600">Elemento</label>
                        <input type="text" name="elemento" id="elemento" value="{{ request('elemento') }}"
                            class="border-gray-300 rounded-md shadow-sm px-2 py-1"
                            placeholder="Nombre del mueble/dispositivo">
                    </div>
                            ...
                            <div class="empty-state">
                                <div class="empty-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                        ...
                                        <path
                                            d="M9 6a2 2 0 0 1-2 2H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-3">
                                        </path>
            ...
            <footer class="report-footer">
                ...
                <p class="text-muted" style="margin-top: 0.5rem;">© {{ date('Y') }} Todos los derechos reservados
                </p>
            </footer>
        </div>
    </body>
