<x-app-layout>
    <div class="min-h-screen flex items-center justify-center bg-gray-100 py-8 px-4">
        <div class="w-full max-w-xl bg-white rounded-xl shadow-lg p-8">
            ...
            <!-- Formulario -->
            <form method="POST" action="{{ route('empleados.store') }}" class="space-y-6" novalidate>
                @csrf
                ...
                <div>
                    ...
                    >
                        <option value="" disabled {{ old('gerencia') ? '' : 'selected' }}>Seleccione una opción...</option>
                        <option {{ old('gerencia') == 'Dirección Ejecutiva' ? 'selected' : '' }}>Dirección Ejecutiva</option>
                        <option {{ old('gerencia') == 'Gerencia Administrativa y Financiera' ? 'selected' : '' }}>Gerencia Administrativa y Financiera</option>
                        <option {{ old('gerencia') == 'Gerencia de Operaciones Registrales' ? 'selected' : '' }}>Gerencia de Operaciones Registrales</option>
                        <option {{ old('gerencia') == 'Gerencia de Servicios Empresariales y Afiliaciones' ? 'selected' : '' }}>Gerencia de Servicios Empresariales y Afiliaciones</option>
                    </select>
                    @error('gerencia')
                ...
                <div>
                    ...
                    >
                        <option value="" disabled {{ old('ubicacion') ? '' : 'selected' }}>Seleccione una ubicación...</option>
                        <option {{ old('ubicacion') == 'Choluteca' ? 'selected' : '' }}>Choluteca</option>
                        <option {{ old('ubicacion') == 'Valle' ? 'selected' : '' }}>Valle</option>
                    </select>
                    @error('ubicacion')
