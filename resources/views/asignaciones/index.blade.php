                ...
                <form method="GET" action="{{ route('asignaciones.index') }}">
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <button type="submit"
                                class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out whitespace-nowrap">
                                Buscar
                            </button>
                                    ...
                                    <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-3">
                                                ...
                                                <form action="{{ route('asignaciones.destroy', $item->id) }}"
